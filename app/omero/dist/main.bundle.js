...
/***/ "./src/app/components/detail-workspace.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return DetailWorkspaceField; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DetailWorkspaceComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_form_field_simple_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-simple.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_form_field_base__ = __webpack_require__("./redbox-portal/angular/shared/form/field-base.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_forms__ = __webpack_require__("./node_modules/@angular/forms/esm5/forms.js");
 ...
 *
 */
var DetailWorkspaceField = /** @class */ (function (_super) {
    __extends(DetailWorkspaceField, _super);
    function DetailWorkspaceField(options, injector) {
        var _this = _super.call(this, options, injector) || this;
        _this.currentPage = 1;
        _this.omeroService = _this.getFromInjector(__WEBPACK_IMPORTED_MODULE_4__omero_service__["a" /* OMEROService */]);
        _this.relatedObjects = [];
    ...
    DetailWorkspaceField.prototype.registerEvents = function () {
    };
    DetailWorkspaceField.prototype.init = function () {
        this.rdmp = this.fieldMap._rootComp.rdmp;
        this.oid = this.fieldMap._rootComp.oid;
    };
    DetailWorkspaceField.prototype.revoke = function () {
        this.loggedIn = false;
    };
    DetailWorkspaceField.prototype.createFormModel = function (valueElem) {
        if (valueElem === void 0) { valueElem = undefined; }
        if (valueElem) {
            this.value = valueElem;
        }
    ...
    DetailWorkspaceField.prototype.setValue = function (value) {
        this.formModel.patchValue(value, { emitEvent: false });
        this.formModel.markAsTouched();
    };
    DetailWorkspaceField.prototype.setEmptyValue = function () {
        this.value = [];
        return this.value;
    };
    return DetailWorkspaceField;
}(__WEBPACK_IMPORTED_MODULE_2__shared_form_field_base__["a" /* FieldBase */]));

/**
 * Component to display information from related objects within ReDBox
 */
var DetailWorkspaceComponent = /** @class */ (function (_super) {
    __extends(DetailWorkspaceComponent, _super);
    function DetailWorkspaceComponent() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DetailWorkspaceComponent.prototype.ngOnInit = function () {
        this.field.init();
    };
    DetailWorkspaceComponent.prototype.ngAfterContentInit = function () {
    };
    DetailWorkspaceComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'ws-detailworkspace',
            template: "<div>\n    Detail Workspace for field {{ field.rdmp }} and oid {{ field.oid }}\n  </div>\n  "
        })
    ], DetailWorkspaceComponent);
    return DetailWorkspaceComponent;
}(__WEBPACK_IMPORTED_MODULE_1__shared_form_field_simple_component__["l" /* SimpleComponent */]));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_detail_workspace_component__ = __webpack_require__("./src/app/components/detail-workspace.component.ts");
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var OMEROFormComponent = /** @class */ (function (_super) {
    ...
    function OMEROFormComponent(elm, RecordsService, fcs, LocationService, OMEROService, translationService) {
        ...
        */
        ...
        _this.action = elm.nativeElement.getAttribute('action');
    ...
    OMEROFormComponent.prototype.loadForm = function () {
        ...
        this.fcs.addComponentClasses({
            ...
            'DetailWorkspaceField': { 'meta': __WEBPACK_IMPORTED_MODULE_11__components_detail_workspace_component__["b" /* DetailWorkspaceField */], 'comp': __WEBPACK_IMPORTED_MODULE_11__components_detail_workspace_component__["a" /* DetailWorkspaceComponent */] }
        });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_detail_workspace_component__ = __webpack_require__("./src/app/components/detail-workspace.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    OMEROModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            declarations: [__WEBPACK_IMPORTED_MODULE_4__omero_form_component__["a" /* OMEROFormComponent */],
                ...
                __WEBPACK_IMPORTED_MODULE_10__components_linkmodal_workspace_component__["a" /* LinkModalWorkspaceComponent */], __WEBPACK_IMPORTED_MODULE_11__components_create_workspace_component__["a" /* CreateWorkspaceComponent */], __WEBPACK_IMPORTED_MODULE_12__components_detail_workspace_component__["a" /* DetailWorkspaceComponent */]
            ],
            exports: [],
            ...
            entryComponents: [__WEBPACK_IMPORTED_MODULE_8__components_login_workspaceapp_component__["a" /* LoginWorkspaceAppComponent */],
                ...
                __WEBPACK_IMPORTED_MODULE_11__components_create_workspace_component__["a" /* CreateWorkspaceComponent */], __WEBPACK_IMPORTED_MODULE_12__components_detail_workspace_component__["a" /* DetailWorkspaceComponent */]
            ]
        })
    ], OMEROModule);
    return OMEROModule;
